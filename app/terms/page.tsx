...
export default function Terms() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <p>
        Advertisements are rendered directly on the page via third-party scripts
        served from our main domain. Popunder and social-bar creatives may open a
        new tab when you interact with clearly labelled sponsor buttons. This is a
        precaution-based setup, not a guarantee of safety, and it does not make
        us responsible for advertiser conduct.
      </p>
