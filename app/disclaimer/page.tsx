...
export default function Disclaimer() {
  return (
    <LegalPage title="Disclaimer">
      ...
      <p>
        Banner and native advertisements are loaded inside restricted frames that
        are configured so an advertisement cannot navigate away from, or tamper
        with, the page you are on. Advertisement clicks open in a new tab. These
        are precautions taken in good faith. They are not a guarantee, and they do
        not transfer responsibility for third-party conduct to us.
      </p>
