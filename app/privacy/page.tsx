  ...
  return (
    <LegalPage title="Privacy Policy">
      ...
      <p>
        ...
        policies, and you should read them. Advertisements are rendered directly
        on the page via third-party scripts on our main domain, and we cannot
        audit or guarantee what any advertiser collects.
      </p>

      <H2>Cookies and local storage</H2>
      <p>
        We use local storage to remember that you accepted our terms, and a
        cookie for administrator login only. Advertising partners (native banners,
        social bar, popunder) and Turnstile may set their own cookies or
        similar identifiers, which we neither control nor have access to. You can
        block or clear cookies in your browser settings; doing so may cause the
        unlock step to ask for consent again.
      </p>
