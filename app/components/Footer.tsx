  ...
  return (
    <footer className="mt-auto border-t border-neutral-800 px-6 py-6 text-center text-xs text-neutral-500">
      <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
        <Link href="/privacy" className="hover:text-neutral-300 underline">
          Privacy Policy
        </Link>
        <Link href="/terms" className="hover:text-neutral-300 underline">
          Terms of Service
        </Link>
        <Link href="/disclaimer" className="hover:text-neutral-300 underline">
          Disclaimer
        </Link>
        <Link href="/dmca" className="hover:text-neutral-300 underline">
          DMCA
        </Link>
        <Link href="/contact" className="hover:text-neutral-300 underline">
          Contact
        </Link>
      </nav>
